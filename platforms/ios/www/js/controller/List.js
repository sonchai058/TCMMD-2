app.controller('ListController', ['$scope', '$stateParams', '$state', 'DataService', '$ionicLoading', '$ionicPlatform', '$cordovaSQLite','$ionicScrollDelegate', function($scope, $stateParams, $state, DataService, $ionicLoading, $ionicPlatform, $cordovaSQLite, $ionicScrollDelegate) {
